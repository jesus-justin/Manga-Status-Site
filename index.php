...
<div class="banner">
  <div class="banner-content">
    <h1>FEATURED: NARUTO</h1>
    <p>One of the top-selling Japanese mangas is now available in your library!</p>
...
?>
    <div class="manga-card">
        <img src="https://via.placeholder.com/160x220?text=<?php echo urlencode($row['title']); ?>" alt="<?php echo htmlspecialchars($row['title']); ?>">
